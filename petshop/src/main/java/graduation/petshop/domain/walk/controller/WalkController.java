...
public class WalkController {
    ...
    @GetMapping
    public ResponseEntity<?> getWalk(@RequestParam final String checkDate) {
    ...
    public ResponseEntity<?> joinWalk(@RequestBody final JoinWalk joinWalk) {
        ...
        return ResponseEntity.ok(walkService.joinWalk(joinWalk));
    }

    @GetMapping("/statistics")
    public ResponseEntity<?> getWalkStatistics(@RequestBody @Valid final StatisticsWalkRequest request) {
